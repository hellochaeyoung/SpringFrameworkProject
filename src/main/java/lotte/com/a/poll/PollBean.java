...
public class PollBean {
    ...
    public PollBean(String id, int syear, int smonth, int sday, int eyear, int emonth, int eday,
        Date sdate, Date edate, String question, int itemcount, String poll1, String poll2,
        String poll3, String poll4, String poll5, String poll6, String poll7, String poll8,
        String poll9, String poll10) {
        this.id = id;
        this.syear = syear;
        this.smonth = smonth;
        this.sday = sday;
    ...
    public String toString() {
        return "PollBean{" +
            ...
            ", poll9='" + poll9 + '\'' +
            ", poll10='" + poll10 + '\'' +
            ", pollnum=" + Arrays.toString(pollnum) +
            '}';
    }
}
